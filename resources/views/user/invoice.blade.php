        ...
        <div class="container">
          <div class="left-content">
                  ...
                  <table>
                    <tr colspan="2">
                      <td>
                        ...
                        @if (Auth::check())
                        <input id="name" type="text" class="fill" name="name" value="{{ Auth::check() ? Auth::user()->cus_name : '' }}">
                        @else
                        <input id="name" type="text" class="fill" name="name" placeholder="Nhập họ tên">
                        @endif
                    ...
                    <tr>
                      <td> 
                        ...
                        @if (Auth::check())
                        <input id="phone" type="text" class="fill" name="phonenum" value="{{ Auth::check() ? Auth::user()->cus_phone : '' }}">
                        @else
                        <input id="phone" type="text" class="fill" name="phonenum" placeholder="Nhập số điện thoại">
                        @endif
                      </td>
                      <td> 
                        ...
                        @if (Auth::check())
                            <input id="email" type="text" class="fill" name="email" value="{{ Auth::check() ? Auth::user()->email : '' }}" style="width: 300px;">
                        @else
                            <input id="email" type="text" class="fill" name="email" placeholder="Nhập email của bạn" style="width: 300px;">
                        @endif
                      </td>
                    </tr>
                  </table>
              ...
              <div class="payment-method"> 
                ...
                <hr>
                  <input type="radio" class="round" id="internet-banking" name="payment" value="internet-banking">
                  <i class="fa-solid fa-building-columns"></i>
                  <label for="internet-banking" class="payment-label">Sử dụng Internet Banking</label>
                  <br>

                  <input type="radio" class="round" id="credit" name="payment" value="vnpay">
                  <img src="images/invoice/vnpay.jpg" style="width: 20px;" alt="">
                  <label for="credit" class="payment-label">Thanh toán bằng VNPay</label>
                  <br>
                ...
                <div class="product-detail">
                  <table class="info-wrapper">
                    <tbody>
                      <tr>
                        <td>
                          <img src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSW5nqd1GUyrOltTiF7YdFAKu_SCaJ3fzTBXuv7JHmwf83C8QsO" alt="PAW Patrol: Phim Siêu Đẳng">
                        </td>
                      </tr>
                    </tbody>
                  </table>
