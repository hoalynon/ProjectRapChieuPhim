                  ...
                  <div class="showtime-container" style="padding:10px;">
                    <select class="listslot" id="listslot" data-selected="">
                        <?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($slot->sl_id); ?>">
                                    <?php echo e($slot->sl_id); ?>
                  ...
                  <div class="product-detail">
                    <table class="info-wrapper">
                      <tbody>
                        <tr>
                          <td>
                            <img src="<?php echo e($movie->mv_link_poster); ?>" alt="">
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <li class="item">
                  <div class="product-detail">
                    <table class="info-wrapper">
                      <tbody>
                        <tr>
                          <td class="label" colspan="2"><?php echo e($movie->mv_name); ?></td>
                        </tr>
                        <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hoàng\git\ProjectRapChieuPhim\cinema\resources\views/user/booking.blade.php ENDPATH**/ ?>