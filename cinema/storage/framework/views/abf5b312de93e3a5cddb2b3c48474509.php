        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label>ID Phim</label>
                    <input type="text" name="id" value="<?php echo e($movie->mv_id); ?>" placeholder="Nhập id phim">
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tranh\cinema\resources\views/admin/movies/edit.blade.php ENDPATH**/ ?>